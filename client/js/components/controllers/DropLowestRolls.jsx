...
class DropLowestRolls extends Component {
  constructor(props) {
    super(props);
    this.state = {
      initialLoad: false,
    ...
    return (
      <div className="col-md-5" style={{verticalAlign: "middle"}}>
        <Card style={{textAlign: "center"}}>
          <CardTitle title="Drop Lowest Rolls" subtitle="Drop the lowest rolls (Accepted Values [1-∞]d[1-8]d[1-8])" />
          <div className="row">
            <input 
            type="text" 
...
export default DropLowestRolls;